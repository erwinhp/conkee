...
$isDisabled1 = function($pksData) {
    return isset($pksData) && $bank1-> =='bsi' && $bank_timer >24  ? 'disabled' : '';
};

$isDisabled2 = function($pksData) {
    return isset($pksData) && $bank2-> =='bsi' && $bank_timer >48 && $bank_timer <24  ? 'disabled' : '';
};


$isDisabled3 = function($pksData) {
    return isset($pksData) && $bank3-> =='bsi' && $bank_timer >72 && $bank_timer <48  ? 'disabled' : '';
};


$isExpired1 = function($pksData) {
    if (isset($pksData) && $pksData->bank1 == 'bsi') {
...
$isExpired2 = function($pksData) {
    if (isset($pksData) && $pksData->bank2 == 'bsi') {
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                @php
                                                    $isDisabled = function($keterangan, $nomor_akun_bank) {
                                                        return ($keterangan === 'soon' || $keterangan === 'expired') ? 'disabled' : '';
                                                    };
                                                @endphp
