...
$isDisabled1 = function($pksData) {
    return isset($pksData) && $bank1-> =='kalsel' && $bank_timer >24  ? 'disabled' : '';
};

$isDisabled2 = function($pksData) {
    return isset($pksData) && $bank2-> =='kalsel' && $bank_timer >48 && $bank_timer <24  ? 'disabled' : '';
};


$isDisabled3 = function($pksData) {
    return isset($pksData) && $bank3-> =='kalsel' && $bank_timer >72 && $bank_timer <48  ? 'disabled' : '';
};


$isExpired1 = function($pksData) {
    if (isset($pksData) && $pksData->bank1 == 'kalsel') {
...
$isExpired2 = function($pksData) {
    if (isset($pksData) && $pksData->bank2 == 'kalsel') {
