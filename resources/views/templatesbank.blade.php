                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
									<div class="header-info">
										...
										<p class="fs-12 mb-0">User Bank</p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="/updatepasswordbank" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/home">List Permohonan</a></li> 
                            <li><a href="/dasboardverifikasi">Permohonan Verifikasi</a></li>
							{{-- <li><a href="/updatedatabank">Update Data Bank</a></li> --}}
						</ul>
                    </li>
                    <!-- FORMS -->
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
