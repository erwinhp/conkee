    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap mb-4 align-items-center search-filter">
            ...
            <div class="mb-0 me-3 mt-3 mt-sm-0 mb-2">
                <form id="filterForm" action="{{ route('home.filterup3pks') }}" method="GET">
                ...
                <div class="table-responsive">
                    <table class="table display mb-4 dataTablesCard table-responsive-xl card-table" id="example5">
                        ...
                        <tbody>
                            ...
                            @php
                            $no_pks=$pks->no_pks;
                            $isDisabled = function($no_pks) {
                                return ($no_pks != NULL ) ? 'disabled' : '';
                            };
                            @endphp
                                <td>{{$pks->id_pks}}</td>
                                ...
                                <td>
                                    ...
                                    @if($pks->no_pks == NULL)
                                    <a class="btn rounded btn-outline-warning me-3 ms-auto" href="#">Belum Ada No PKS</a>
                                    @elseif($pks->no_pks != NULL)
                                        <a class="btn rounded btn-outline-success me-3 ms-auto" href="#">No PKS Terisi</a>
                                    @endif
                                        <div class="dropdown float-end custom-dropdown mb-0  c-pointer">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                {{-- <a class="dropdown-item" href="{{ route('up3.inputpks', ['id_pks' => $pks->id_pks]) }}">Details</a> --}}
                                                <button 
                                                class="dropdown-item btn btn-link" 
                                                onclick="window.location.href='{{ route('up3.inputpks', ['id_pks' => $pks->id_pks]) }}'" 
                                                {{ $isDisabled($no_pks) }}>
                                                Details
                                                </button>
