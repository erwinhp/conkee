    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap mb-4 align-items-center search-filter">
            <div class="me-auto mb-2 pe-2">
                <h6 class="text-black fs-16 font-w600 mb-1">{{count($users)}} USER</h6>
                    ...
                    <table class="table display mb-4 dataTablesCard table-responsive-xl card-table" id="example5">
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <td>
                                    <div class="media">
                                        ...
                                        <div class="media-body text-nowrap">
                                            <h6 class="text-black font-w600 fs-16 mb-0">{{$user->email}}.</h6>
                                ...
                                <td>
                                    <a href="{{ route('admin.userupdate', ['id' => $user->id]) }}" class="btn btn-primary">
                                        Update User Admin
                                    </a>
                                </td>
